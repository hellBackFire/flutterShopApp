...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        "https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyDaUBSz-SNkrPD-MPqFstvQ67RK3Nx2Y6U";
    try {
  ...
  Future<void> signup(String email, String password) async {
    ...
    //   const url =
    //       "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDaUBSz-SNkrPD-MPqFstvQ67RK3Nx2Y6U";
